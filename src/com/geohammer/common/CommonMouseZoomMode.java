 ...
 * @version 2004.12.29
 */
public class CommonMouseZoomMode extends Mode {
	 ...
	 */
	public CommonMouseZoomMode(ModeManager modeManager) {
		super(modeManager);
		setName("Zoom");
		setIcon(loadIcon(CommonMouseZoomMode.class,"ZoomIn16.gif"));
